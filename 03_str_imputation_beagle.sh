...
# Paths
base_dir="/projects/hearing_loss/clsaARHL_SA/str"
beagle="/projects/hearing_loss/clsaARHL_SA/home_dir/beagle.27May24.118.jar"
...
java -Xmx100g -jar $beagle \
	gt=$base_dir/chr${chr}/input/fixed_genotype_chr${chr}.vcf.gz \
       ref=$base_dir/str_ref/chr${chr}/ensembletr_refpanel_v4_chr${chr}.bref3 \
       out=$base_dir/test_dir/chr${chr}/input/imputed_STR_SNPs_chr${chr}
